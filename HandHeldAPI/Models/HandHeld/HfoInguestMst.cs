...
public partial class HfoInguestMst
{
    ...
    public bool? Sbagg { get; set; }

    public short? BaggCount { get; set; }

    public string? Status { get; set; }

    public string? Vvgrno { get; set; }
    ...
    public string? MealRemark { get; set; }

    public string? BillIns { get; set; }

    public string? BillToComp { get; set; }

    public string? MealCheck { get; set; }
    ...
    public string? TrnModify { get; set; }

    public string? Buid { get; set; }

    public string? Mgrno { get; set; }

    public short? Nop { get; set; }

    public string? IpAddress { get; set; }

    public string? CoipAddress { get; set; }

    public string? GMemId { get; set; }

    public string? M2grno { get; set; }

    public string? BookingSource { get; set; }

    public string? Mktsgm { get; set; }

    public string? Font { get; set; }

    public string? LtonStariff { get; set; }
