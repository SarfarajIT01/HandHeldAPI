...
public partial class PfbGuest
{
    ...
    public string? GIdentifier { get; set; }
    ...
    public float? EarnPoint { get; set; }

    public float? RedimPoint { get; set; }
    ...
    public string? PicSpouce { get; set; }
