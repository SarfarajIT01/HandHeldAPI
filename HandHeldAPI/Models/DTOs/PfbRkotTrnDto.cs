...
{
    public partial class PfbRkotTrnDto
    {
        ...
        public string? RkotPost { get; set; }
        ...
        public decimal? OthTax { get; set; }
        public string? RkotCvr { get; set; }
        public string? RkotMc { get; set; }
        public string? DiscTyp { get; set; }
        public string? TableInstruction { get; set; }
        public decimal? HhDisc { get; set; }
